...
| Väli | Väärtus |
|---|---|
| **Security group name** | `tiim-36-web-sg-rain` |
| **Description** | `Security group for web server - rain` |
| **VPC** | `vpc-02fb02f6b35b49a55 (NaVa)` |

> **Nimetamiskonventsioon:** Kasutame formaati `tiim-36-<ressurss>-<sinu-nimi>`, et eristada enda ressursse teiste tiimiliikmete omadest jagatud kontol. Näiteks: `tiim-36-web-sg-rain`
...
Pärast loomist peaksid nägema kinnitussõnumit ja Security Group ID-d. Näiteks: `sg-0b0819740fbc2e6bc - tiim-36-web-sg-rain`. Kirjuta see ID üles – vajad seda EC2 instants'i loomisel.
...
4. Märgi linnuke security group'i `tiim-36-web-sg-rain` (või sinu loodud security group) ees
...
cd /var/www/html
echo "<html><h1>rain</h1></html>" > index.html
```
...
> - Mõlemad installivad Apache HTTP serveri (`httpd`), käivitavad selle ja loovad lihtsa HTML lehe tekstiga "rain"
...
2. Otsinguribas **Find Instance by attribute or tag (case-sensitive)** sisesta: `tiim-36-web-server-rain`
...
1. Kliki instance'i nimel (`tiim-36-web-server-rain`), et avada **Instance summary**
...
Peaksid nägema lehte tekstiga: **rain**
...
1. Vasakpoolses menüüs vali **Instances**
2. Leia oma instance **tiim-36-web-server-rain** (või otsi otsinguribas)
...
```
<html><h1>rain</h1></html>
```

Kui näed ülalpool olevat HTML koodi, siis veebileht on õigesti loodud ja peaks brauseris kuvama teksti "rain".
...
| Väli | Väärtus |
|---|---|
| **Role name** | `tiim-36-web-s3-access-rain` |
...
| Key | Value |
|---|---|
| `Name` | `tiim-36-web-s3-access-rain` |

### 6.7 Role loomine

Vajuta **Create role**

Pärast loomist peaksid nägema kinnitussõnumit: **Role tiim-36-web-s3-access-rain created**
...
1. Otsi ja leia instance **tiim-36-web-server-rain**
...
1. Otsinguribas otsi **tiim-36-web-s3-access-rain**
2. Vali rippmenüüst **tiim-36-web-s3-access-rain**
